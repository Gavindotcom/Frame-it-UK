    ...
    <main className="site">
      ...
      <section className="hero">
        <div className="heroText">
          ...
          <p className="sub">
            Premium bespoke framing for shirts,
            signed memorabilia and sporting keepsakes.
      ...
      <section className="section">
        ...
        <h2>
          Turn sporting memories into display pieces.
        </h2>

        <p className="sub">
          Whether it’s a signed shirt,
          a match-worn item, a medal,
          gloves or a club gift,
          Frame It UK creates clean,
          premium displays that protect
      ...
      <section className="cta">
        ...
        <p>
          Send us a photo of your item
          and we’ll come back with options.
        </p>
